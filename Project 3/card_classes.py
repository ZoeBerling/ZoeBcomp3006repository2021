...
def main():
    ...
    while a != 0 and len(white_deck.return_list()) != 0:

        if a == 0 or len(white_deck.return_list()) == 0:
            ...
            for i in range(j):
                ...
                if a == 0:
                    ...
                    played_cards.group_cards(dis_card.return_card(), options.return_card(a-1))  # shallow copy
